...
var global_default = "/build/_assets/global-FJB6BC2P.css";
...
function Index7() {
  ...
  return (0, import_react7.useEffect)(() => {
    if (!localStorage.getItem("jeffamzn_subscribed")) {
      let timer = setTimeout(() => setShowModal(!0), 500);
