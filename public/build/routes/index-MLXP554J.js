...
function Index() {
  ...
  const topFormRef = (0, import_react.useRef)(null);
  const bottomFormRef = (0, import_react.useRef)(null);
  const topWidgetId = (0, import_react.useRef)(null);
  const bottomWidgetId = (0, import_react.useRef)(null);
  const submittingFormRef = (0, import_react.useRef)(null);
  (0, import_react.useEffect)(() => {
    ...
    window.hcaptchaOnLoad = () => {
      if (window.hcaptcha) {
        if (topFormRef.current) {
          topWidgetId.current = window.hcaptcha.render(
        ...
        if (bottomFormRef.current) {
          bottomWidgetId.current = window.hcaptcha.render(
  ...
  const handleFormSubmit = (which) => (e) => {
    var _a, _b;
    e.preventDefault();
    submittingFormRef.current = which;
    if (window.hcaptcha) {
      if (which === "top" && topWidgetId.current !== null) {
        window.hcaptcha.execute(topWidgetId.current);
      } else if (which === "bottom" && bottomWidgetId.current !== null) {
        window.hcaptcha.execute(bottomWidgetId.current);
      } else {
        (_a = which === "top" ? topFormRef.current : bottomFormRef.current) == null ? void 0 : _a.submit();
      }
    } else {
      (_b = which === "top" ? topFormRef.current : bottomFormRef.current) == null ? void 0 : _b.submit();
    }
  };
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
          "form",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "h-captcha" }, void 0, false, {
                fileName: "app/routes/index.tsx",
                lineNumber: 170,
                columnNumber: 9
              }, this),
...
//# sourceMappingURL=/build/routes/index-MLXP554J.js.map
