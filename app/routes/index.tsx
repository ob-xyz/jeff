  ...
  return (
    <div className="container">
      ...
      <div className="inner-content2">
        ...
        <Link className="text" to="/subscribe">Quit doomscrolling to stay ahead. Jeffamazon is a one minute news feed for entrepreneurs, leaders, and product idea machines who enjoy daily stories and insights straight from the front lines of business and tech</Link>
      </div>
