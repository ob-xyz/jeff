...
return (
    <div className="container">
      ...
      <div className="text">
         ...
         <p>Jeffamzn lights up your inbox with enjoyable business news, unmatched insights, and boiling hot takes that matter more every day to business leaders like me and you.</p>
      </div>
