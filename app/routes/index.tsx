  ...
  return (
    <div className="container">
      ...
      <div className="inner-content4">
            ...
            <p>Regular news makes you feel bad and social media just wants you to doom-scroll to infinity. <b>Jeffamazon is the antidote.</b> It's our 1-minute newsletter keeping <b>40,000+</b> people ahead of the curve. Sign up <a title="subscription form" href="https://jeffamazon.com/subscribe"  rel="noopener noreferrer">here →</a></p></div>
