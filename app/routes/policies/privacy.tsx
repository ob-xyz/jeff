  ...
  return (
    <div className="content-privacy">
      ...
      <div className="content-privacy2">
        ...
        <p>Jeffamzn respects your privacy and values your trust. This Privacy Policy (“Policy”) describes how we collect and use your information and explains your rights and options. This Policy applies to these services (which we call the “Services” in this Policy):</p>
        <ul>
          <li>websites, the Jeffamzn Store, paid products</li>
        ...
        <p>We encourage you to read this Policy carefully. If you have questions, please contact us at <a href="mailto:privacyrequest@jeffamzn.com">privacyrequest@jeffamzn.com</a>.</p>
        <p>1. About This Policy And Us</p>
        <p>(a)Who we are</p>
        <p>Jeffamzn, Inc. (“Jeffamzn,” “we”, “our” or “us”) operates the Services. This Policy supplements and is governed by our Terms of Service (“Terms”). Capitalized terms used but not defined in this Policy are defined in our Terms. The Terms describe how the Services work in general and its conditions and requirements of use.</p>
        ...
        <ul>
          ...
          <li>If you are a current or former employee or contractor of ours, this Policy does not apply to you. You may contact us about your privacy practices and rights at <a href="mailto:privacyrequest@jeffamzn.com">privacyrequest@jeffamzn.com</a>.</li>
        ...
        <p>If those sections apply to you, they override any contrary descriptions elsewhere in the Policy as they relate to you. Please contact us at <a href="mailto:privacyrequest@jeffamzn.com">privacyrequest@jeffamzn.com</a> if you have questions about your rights under other data privacy laws.</p>
        ...
        <ul>
          <li>“Commercial Information” about your orders of Offerings or other products or services from us and interactions with Jeffamzn Store products.</li>
